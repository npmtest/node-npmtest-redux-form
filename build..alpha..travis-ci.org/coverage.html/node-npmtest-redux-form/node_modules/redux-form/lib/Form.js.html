...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-redux-form/node_modules/redux-form/lib/Form.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-redux-form/node_modules/redux-form/lib/Form.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-redux-form/node_modules/redux-form/lib/</a> &#187; Form.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Form(props, context) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Form);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Form.__proto__ || Object.getPrototypeOf(Form)).call(this, props, context));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!context._reduxForm) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Form must be inside a component decorated with reduxForm()');</span>
    }
...
<span class="cstat-no" title="statement not covered" >      this.context._reduxForm.registerInnerOnSubmit(this.props.onSubmit);</span>
    }
  }, {
    key: 'render',
    value: <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement('form', this.props);</span>
    }
  }]);
&nbsp;
  return Form;
